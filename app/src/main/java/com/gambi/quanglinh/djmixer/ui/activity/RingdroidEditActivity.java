...
import com.gambi.quanglinh.djmixer.waveform.MarkerView;
import com.gambi.quanglinh.djmixer.R;
import com.gambi.quanglinh.djmixer.waveform.SamplePlayer;
import com.gambi.quanglinh.djmixer.waveform.WaveformView;
import com.gambi.quanglinh.djmixer.dialog.AfterSaveActionDialog;
import com.gambi.quanglinh.djmixer.dialog.FileSaveDialog;
import com.gambi.quanglinh.djmixer.soundfile.SoundFile;
 ...
 */
    ...
    private Button btnTrim,btnCopy,btnReset;
    // Result codes
    private static final int REQUEST_CODE_CHOOSE_CONTACT = 1;
    private TextView mSubtract,mAdd;
    /**
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        btnTrim.setOnClickListener(new OnClickListener() {
            @Override
        ...
        btnCopy.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                FileSaveDialog dlog = new FileSaveDialog(
                        RingdroidEditActivity.this, getResources(), mTitle, message);
                dlog.show();
            }
        });
...
//        }
    ...
    private void loadGui() {
        ...
        btnTrim = (Button)findViewById(R.id.btnSave);
        btnReset = (Button)findViewById(R.id.btnReset);
        btnCopy = (Button)findViewById(R.id.btncopy);
        mSubtract = (TextView) findViewById(R.id.tvt_subtract);
        mAdd = (TextView) findViewById(R.id.tvt_add);
...
//                String outPath = makeRingtoneFilename(title, ".m4a");
                String outPath = "/storage/emulated/0/Music/testDJAPp.wav";
//                String outPath = "/storage/emulated/0/Download/VoiceEffects/1691399244117_alien.wav";
                if (outPath == null) {
                    Runnable runnable = new Runnable() {
                        public void run() {
...
//                }
    ...
    private void pasteAudio(final CharSequence title) {
        double startTime = mWaveformView.pixelsToSeconds(mStartPos);
        double endTime = mWaveformView.pixelsToSeconds(mEndPos);
        double maxTime = mWaveformView.pixelsToSeconds(mMaxPos);
        final int startFrame = mWaveformView.secondsToFrames(startTime);
...
//                String outPath = "/storage/emulated/0/Music/testDJAPp.wav";
                ...
                try {
                    // Write the new file
                    mSoundFile.PasteToFile(outFile,  startFrame, endFrame - startFrame,maxFrame);
                } catch (Exception e) {
                    // log the error and try to create a .wav file instead
                    if (outFile.exists()) {
                        outFile.delete();
